...
- (WSPostDeviceTokenRequest *)getNotificationList:(NSDictionary *)paraDic {
    ...
    DBG(@"%@",[self _accessToken]);
    [request setValue:[self _accessToken] forHTTPHeaderField:@"Authorization"];
    NSString *paramenter = [NSString stringWithFormat:@"%@?%@&%@&%@",WS_METHOD_GET_NOTIFICATION_TOKEN_LIST,[paraDic objectForKey:device_token_dic],[paraDic objectForKey:device_type_dic],[paraDic objectForKey:application_name_dic]];
