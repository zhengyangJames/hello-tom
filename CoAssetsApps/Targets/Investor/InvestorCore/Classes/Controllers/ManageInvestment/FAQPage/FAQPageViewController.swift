...
class FAQPageViewController: BaseViewController {
    ...
    lazy var dataArray: [AppDefine.FAQStruct] = {
        ...
        let arrayPlist = []
        guard let arrayTemp = ResourcesHelper.readPlistFile("PAQPlist") else {
            return dataArr
        }
...
extension FAQPageViewController {
    private func tableView(tableView: UITableView, cellNormalForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        if let cell = tableview.dequeueReusableCellWithIdentifier(FAQPageCell.className, forIndexPath: indexPath) as? FAQPageCell {
    ...
    private func tableView(tableView: UITableView, cellDropForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        if let cell = tableview.dequeueReusableCellWithIdentifier(FAQPageDropCell.className, forIndexPath: indexPath) as? FAQPageDropCell {
            return cell
        } else {
            return UITableViewCell()
        } 
