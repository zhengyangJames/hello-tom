...
//    
//    lazy private var datasources:[String]! = {
//        var datas = [String]()
//        for i in 0..<6 {
//            let page = "page\(i)"
//            datas.append(page)
...
extension ProjectListViewController {
    var dataArray: NSArray? {
        guard let array = ResourcesHelper.readFilePlist("ProjectList") else {
            return []
        }
...
//MARK: Private
extension ProjectListViewController {
    func setBackGroundTabbarView(view1:COTabbaView, view2:COTabbaView, view3:COTabbaView ) {
...
extension ProjectListViewController:UICollectionViewDataSource {
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCellWithReuseIdentifier(ProjectListCell.className, forIndexPath: indexPath) as! ProjectListCell
        cell.objectButton = dataArray![indexPath.row]
        cell.delegate = self
        return cell
    }
}
