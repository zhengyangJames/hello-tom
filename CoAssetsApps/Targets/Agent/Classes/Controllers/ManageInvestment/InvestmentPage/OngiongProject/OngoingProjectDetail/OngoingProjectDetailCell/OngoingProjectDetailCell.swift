...
class OngoingProjectDetailCell: UITableViewCell {
    ...
    @IBOutlet weak private var client: UILabel!
    @IBOutlet weak private var statusLabel: UILabel!
    @IBOutlet weak private var indicativeLabel: UILabel!
    @IBOutlet weak private var commissionLabel: UILabel!
    @IBOutlet weak private var commissionPayntLabel: UILabel!
    
    @IBOutlet weak private var titleLabel: UILabel!
    @IBOutlet weak private var clientDetailDetailLabel: UILabel!
    @IBOutlet weak private var statusDetailLabel: UILabel!
    @IBOutlet weak private var indicativeDetailLabel: UILabel!
    @IBOutlet weak private var commissionDetailLabel: UILabel!
    @IBOutlet weak private var commissionPayntDetailLabel: UILabel!
